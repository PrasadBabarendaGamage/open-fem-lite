...
REGION.GENERATED_MESHES.GeneratedMeshMaximumExtentSet(GeneratedMeshUserNumber,[10,10,0]) #Size
REGION.GENERATED_MESHES.GeneratedMeshNumberOfElementsSet(GeneratedMeshUserNumber,[2,2])
...
REGION.WriteIpCoor(GeometricFieldUserNumber,1,"Output/2D/REGION")
REGION.WriteIpBase(GeometricFieldUserNumber,1,"Output/2D/REGION")
REGION.WriteIpNode(GeometricFieldUserNumber,1,"Output/2D/REGION")
REGION.WriteIpElem(GeometricFieldUserNumber,1,"Output/2D/REGION")
