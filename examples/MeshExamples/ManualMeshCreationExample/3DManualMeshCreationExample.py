...
REGION.MESHES.MeshElementsNodesSet(MeshUserNumber,MeshComponent,1,[1,2,3,4,5,6,7,8])
REGION.MESHES.MeshElementsNodesSet(MeshUserNumber,MeshComponent,2,[1,2,3,4,8,10,11,12]) #element,element_nodes
...
FieldVariable = 1
REGION.FIELDS.FieldParameterSetUpdateNode(GeometricFieldUserNumber,FieldVariable,1,1,8,1,30.0)#version_idx,derivative_idx,node_idx,field_component_idx,value
REGION.FIELDS.FieldParameterSetUpdateNode(GeometricFieldUserNumber,FieldVariable,1,1,8,1,40.0) 
REGION.FIELDS.FieldParameterSetUpdateNode(GeometricFieldUserNumber,FieldVariable,1,1,1,3,50.0)
...
REGION.FIELDS.FieldParameterSetUpdateNode(GeometricFieldUserNumber,FieldVariable,1,1,2,3,50.0)
...
REGION.FIELDS.FieldParameterSetUpdateNode(GeometricFieldUserNumber,FieldVariable,1,1,3,3,50.0)
...
REGION.FIELDS.FieldParameterSetUpdateNode(GeometricFieldUserNumber,FieldVariable,1,1,4,3,50.0)
...
REGION.WriteIpCoor(GeometricFieldUserNumber,1,"Output/3DMeshIn3DSpace")
REGION.WriteIpBase(GeometricFieldUserNumber,1,"Output/3DMeshIn3DSpace")
REGION.WriteIpNode(GeometricFieldUserNumber,1,"Output/3DMeshIn3DSpace")
REGION.WriteIpElem(GeometricFieldUserNumber,1,"Output/3DMeshIn3DSpace")
REGION.WriteCmCom(GeometricFieldUserNumber,1,"Output/3DMeshIn3DSpace")
REGION.WriteCmguiCom(GeometricFieldUserNumber,1,"Output/3DMeshIn3DSpace")
