...
def GenerateCantileverBeamMesh(Extent,NumberOfElements,OutputDirectory):
    NumberOfXi = 3
    ...
    REGION.WriteIpNode(GeometricFieldUserNumber,1,OutputDirectory)
    REGION.WriteIpElemAndLinearHydrostaticPressure(GeometricFieldUserNumber,1,OutputDirectory)

if __name__ == "__main__":
    Extent = [60.0,40.0,40.0]
    NumberOfElements = [4,2,2]
    OutputDirectory = "../CMISS/Mesh/beam"
