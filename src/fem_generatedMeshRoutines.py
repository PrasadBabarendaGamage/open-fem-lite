            ...
            for Y_COUNTER in range(GENERATED_MESH.TOTAL_NUMBER_OF_NODES_XIC[2]):
                for X_COUNTER in range(GENERATED_MESH.TOTAL_NUMBER_OF_NODES_XIC[1]):
                    ...
                    for XIC_COORDINATE in range(BASIS.NUMBER_OF_XIC):
                        ...
                        REGION.FIELDS.FieldParameterSetUpdateNode(FIELD_USER_NUMBER,FIELD_VARIABLE_USER_NUMBER,1,1,FIELD_NODE_USER_NUMBER,FIELD_COMPONENT_USER_NUMBER,float(VALUE[XIC_COORDINATE]))
                    REGION.FIELDS.FieldParameterSetUpdateNode(FIELD_USER_NUMBER,FIELD_VARIABLE_USER_NUMBER,1,2,FIELD_NODE_USER_NUMBER,1,float(1.0))#MAXIMUM_EXTENT[0]/GENERATED_MESH.NUMBER_OF_ELEMENTS_XIC[1]))
                    REGION.FIELDS.FieldParameterSetUpdateNode(FIELD_USER_NUMBER,FIELD_VARIABLE_USER_NUMBER,1,3,FIELD_NODE_USER_NUMBER,2,float(1.0))#MAXIMUM_EXTENT[1]/GENERATED_MESH.NUMBER_OF_ELEMENTS_XIC[2]))
                    REGION.FIELDS.FieldParameterSetUpdateNode(FIELD_USER_NUMBER,FIELD_VARIABLE_USER_NUMBER,1,5,FIELD_NODE_USER_NUMBER,3,float(1.0))#MAXIMUM_EXTENT[2]/GENERATED_MESH.NUMBER_OF_ELEMENTS_XIC[3]))
                    VALUE[0] = float(VALUE[0]) + float(MAXIMUM_EXTENT[0])/float((GENERATED_MESH.TOTAL_NUMBER_OF_NODES_XIC[1]-1))
                VALUE[1] = float(VALUE[1]) + float(MAXIMUM_EXTENT[1])/float((GENERATED_MESH.TOTAL_NUMBER_OF_NODES_XIC[2]-1))
                VALUE[0] = 0.0
            VALUE[2] = float(VALUE[2]) + float(MAXIMUM_EXTENT[2])/float((GENERATED_MESH.TOTAL_NUMBER_OF_NODES_XIC[3]-1))
            VALUE[1] = 0.0
